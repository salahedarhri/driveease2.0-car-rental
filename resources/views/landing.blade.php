...
<article x-data="{ imageLanding:false }" class="w-full bg-slate-200">
  {{-- First Section : done --}}
    <section class="max-w-7xl mx-auto pb-8">
      <section class="font-montserrat grid md:grid-cols-2 max-md:grid-cols-1 gap-0 max-w-7xl mx-auto justify-center items-center p-2">
        <div class="px-4 md:pt-12 max-md:pt-6 max-md:text-center">
          ...
          <h1 class="md:text-4xl sm:text-3xl max-sm:text-2xl py-3 text-sky-800 font-bold">Trouvez la voiture qui vous correspond</h1>
          <p class="text-md text-darkBlue pb-3">&ensp;Que vous planifiez une escapade en ville, une aventure sur la route
  ...
  <section class="w-full bg-white flex flex-col gap-4 place-items-center text-center font-montserrat md:py-12 max-md:py-8">
    ...
    <div class="grid md:grid-cols-3 max-md:grid-cols-1 justify-center items-stretch lg:gap-4 max-lg:gap-2 mx-auto lg:py-8">
