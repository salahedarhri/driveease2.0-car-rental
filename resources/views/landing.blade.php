...
@section('content')
    ...
    <!-- First Part -->
    <div class="w-screen bg-slate-100 border-b-2">

      <div class="max-w-7xl mx-auto max-md:pb-3">
        <div class="montserrat grid md:grid-cols-2 max-md:grid-cols-1 gap-0 max-w-7xl mx-auto justify-center items-center">
          ...
          <div class="svgBackground p-4 max-md:hidden">
    ...
    <div class="w-screen bg-slate-100">
      <div class="max-w-7xl  mx-auto">
        <div class="montserrat grid sm:grid-cols-2 max-sm:grid-cols-1 gap-0 max-w-7xl mx-auto justify-center items-center">
  ...
  <!-- fourth part -->
    <div class="w-screen bg-blue-100">
      <div class="montserrat grid md:grid-cols-3 max-md:grid-cols-1 justify-center max-w-7xl mx-auto md:p-10 max-md:p-3 text-white md:gap-8 max-md:gap-3">
        <!-- Calendar -->
