...
<!-- First Part -->
<div x-data="{ shown:false }" class="w-full bg-slate-200">
  ...
  <div class="max-w-7xl mx-auto pb-8">
    <div class="font-montserrat grid md:grid-cols-2 max-md:grid-cols-1 gap-0 max-w-7xl mx-auto justify-center items-center">
      ...
      <div x-intersect:enter="shown=true" class="px-4">
        <img x-show="shown" x-transition.duration.500.delay.500 src="{{ asset('images/composants/landing.png') }}" alt="landing car photo" 
