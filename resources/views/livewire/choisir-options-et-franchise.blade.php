    ...
    <div class="w-full bg-slate-200 px-4">
        ...
        <div class="max-w-7xl mx-auto p-4 max-sm:px-0 font-cabin">
            ...
            <div class="grid grid-cols-3 gap-3 max-lg:grid-cols-1 w-full">
                    ...
                    <div class="bg-teal-100 rounded shadow-lg shadow-teal-600 p-4 max-lg:text-center">
                        ...
                        <div class="bg-white rounded shadow-lg p-4 max-lg:text-center">
                            ...
                            <p class="text-2xl font-montserrat font-bold">{{ $prtc->type }}
                                ...
                                <span class="text-teal-500 text-xl font-normal ml-2">&#128970;</span>
                            </p>
                            ...
                            <div class="font-montserrat flex flex-col justify-center align-center text-center pt-4">
                                ...
                                <div class="flex flex-col gap-2 p-4 max-lg:text-center">
                                    ...
                                    @if( isset($protectionChoisi) && $prtc == $protectionChoisi)
                                    <button
                                        class="p-2 font-semibold bg-neutral-500 hover:bg-neutral-600 rounded shadow transition text-white my-4 w-full"
                                        disabled>Sélectionnée</button>
                                    @else
                                    <button wire:click="choisirProtection({{ $prtc->id }})"
                                        class="p-2 font-semibold bg-teal-500 hover:bg-teal-600 rounded shadow transition text-white my-4 w-full">Sélectionner</button>
                                    @endif
                ...
                {{-- Section Options --}}
                <div
                    class="grid grid-cols-4 max-xl:grid-cols-3 max-lg:grid-cols-2 max-sm:grid-cols-1 max-w-7xl mx-auto gap-4 p-2">
                    ...
                    <div x-data="{ open:false }">
                        ...
                        <div
                            ...
                            <button wire:key="retirer-{{ $optn->id }}" wire:click="RetirerOption({{ $optn->id }})"
                                class="bg-white py-2 px-4 text-teal-500 border-2 border-teal-500 font-semibold shadow rounded font-montserrat my-3 w-fit self-end">
                                Retirer</button>
                        </div>
                        ...
                        <div class="bg-white flex flex-col justify-center p-3 rounded-lg shadow-lg">
                            ...
                            <button wire:key="ajouter-{{ $optn->id }}" wire:click="AjouterOption({{ $optn->id }})"
                                class="py-2 px-4 bg-cyan-500 text-white font-semibold shadow rounded font-montserrat my-3 w-fit self-end">Sélectionner</button>
