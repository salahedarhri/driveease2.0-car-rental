<div x-data="{ openModal:false, openDisplay:false, imageChoisi:'' }">
  ...
  <p class="text-lg max-md:text-md text-cyan-900 p-3 mt-3">Liste des voitures</p>
    ...
    <table class="table md:table-sm max-md:table-xs md:px-1">
      ...
      <thead class="text-lightBlue">
        <tr class="border-b-slate-300">
          ...
          <th>Boîte</th>
          <th>Clim.</th>
          <th class="cursor-pointer" wire:click="sortBy('nbPers')">Nbre Pers.@if($ordreVariable =='nbPers' && $ordre == 'asc') &#11205; @elseif($ordreVariable == 'nbPers' && $ordre == 'desc') &#11206; @else &#11032; @endif</th>
      ...
      <tbody >
        ...
        @foreach($voitures as $voiture)
          <tr class="border-b-slate-300 hover:bg-sky-100">
            <td class="w-full max-md:hidden flex justify-center">
              <div class="avatar" @click="openDisplay=true; imageChoisi='{{ asset('images/voitures/'.$voiture->photo ) }}' ">
