        ...
        <div class="max-w-5xl mx-auto py-2 font-cabin">
            ...
            @else
                ...
                @foreach ($voituresDisponibles as $car)
                    <div wire:key="{{ $car->slug }}" x-data="{ openModal:false }">
                        ...
                        <div class="bg-white overflow-hidden flex flex-col sm:flex-row px-2 border-b-2">
                            ...
                            <button @click="openModal=!openModal" class="px-2 py-1 mt-3 rounded-md font-semibold font-montserrat text-teal-500">
                        ...
                        <div x-cloak x-show="openModal" @click.outside="openModal=false" x-transition:enter="transition ease-out duration-300"
