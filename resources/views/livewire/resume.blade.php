<div>
  ...
  <div class="w-full bg-slate-200">
    <div class="max-w-5xl mx-auto p-4">
      ...
      <div class="flex flex-col w-full pt-4 border border-darkBlue border-opacity-50 rounded-lg bg-white mt-4">
      ...
      <div class="flex flex-col w-full p-4 border border-darkBlue border-opacity-50 rounded-lg bg-white mt-4">
        <div class="flex flex-row justify-between">
          <p class="text-2xl font-montserrat font-bold">Total</p>
          <p class="text-2xl text-teal-600 font-montserrat font-bold">{{ ($voiture->prix * $nbJrs) + $prixPrtc +
            $prixOptns }} DH</p>
        </div>
      </div>
    </div>
  ...
  <div class="w-full bg-stone-50">
    <div class="max-w-5xl mx-auto p-4">
      <p class="text-xl font-bold font-montserrat pb-4">Détails du conducteur</p>
