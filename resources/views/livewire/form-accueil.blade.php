        ...
        <div class="grid lg:grid-cols-2 grid-cols-1 justify-center max-lg:gap-2">
            ...
            <div class="flex flex-row max-sm:flex-col w-full max-lg:gap-2">
                ...
                <label for="dateDepart" class="w-full">
                    <input id="dateTime1" name="dateDepart" type="text" placeholder="Date de départ" wire:model.blur="dateDepart"
                ...
                <label for="dateRetour" class="w-full">
                    <input id="dateTime2" name="dateRetour" type="text" placeholder="Date de retour" wire:model.blur="dateRetour"
