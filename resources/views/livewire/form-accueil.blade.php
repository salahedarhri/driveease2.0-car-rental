        ...
        <div class="grid lg:grid-cols-2 grid-cols-1 justify-center max-lg:gap-2">
            ...
            <div class="flex flex-row max-sm:flex-col w-full max-lg:gap-2">
                ...
                <label for="lieuDepart" class="w-full" x-data="{ lieuDepart:''}">
                    ...
                    <input name="lieuDepart" type="text" placeholder="Lieu de départ" wire:model.live.debounce.50ms="lieuDepart" autocomplete="off" x-model="lieuDepart" class="relative w-full p-3 cursor-pointer focus:ring-0 border-2 border-slate-300 focus:border-teal-500 max-lg:rounded-lg lg:rounded-l-xl">
                    ...
                    @if( $indicDepart && $lieuDepart != null )
                        <div wire:transition class="absolute z-30 mt-1 w-80 bg-white rounded shadow-xl p-2 font-cabin">
                            <p class="text-md p-2">Pas de résultats.</p>
                        </div>
