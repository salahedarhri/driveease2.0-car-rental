...
<body class="overflow-x-hidden antialiased font-swap">
    ...
    <nav class="font-montserrat flex justify-between px-6 md:py-2 max-md:py-1 max-md:px-2 max-w-7xl mx-auto  text-white">
      ...
      <ul class="flex flex-row place-items-center gap-8 py-0 max-md:hidden font-montserrat font-semibold">
        <li class="md:px-1 lg:px-2 transition-all hover:underline">
          <a wire:navigate href="{{ route('accueil') }}" class="hover:text-lightBlue">Accueil</a>
        </li>
        <li class="md:px-1 lg:px-2 transition-all hover:underline">
          <a wire:navigate href="{{ route('cars') }}" class="hover:text-lightBlue">Voitures</a>
        </li>
        <li class="md:px-1 lg:px-2 transition-all hover:underline">
          <a wire:navigate href="{{ route('apropos') }}" class="hover:text-lightBlue">À propos</a>
        </li>
      </ul>
      ...
      <div class="flex flex-row items-center max-md:hidden">
        @auth
          <a wire:navigate href="{{ route('dashboard') }}"
            class="font-semibold text-base px-3 py-1 hover:text-lightBlue hover:underline rounded">Espace Client</a>
        @endauth
        @guest
      ...
      <div class="md:hidden flex items-center align-center justify-center">
        ...
        <div class="dropdown dropdown-end">
          ...
          <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-40 text-darkBlue">
            <li><a wire:navigate class="font-semibold tracking-wide" href="{{ route('accueil') }}">Accueil</a></li>
            <li><a wire:navigate class="font-semibold tracking-wide" href="{{ route('cars') }}">Voitures</a></li>
            <li><a wire:navigate class="font-semibold tracking-wide" href="{{ route('apropos') }}">À propos</a></li>
          </ul>
        </div>
      </div>
    </nav>
  ...
  <footer
    ...
    <nav class="grid sm:grid-flow-col max-sm:grid-cols-1 gap-8">
      <a wire:navigate href="{{ route('apropos') }}" class="link link-hover hover:text-teal-500 transition">À propos</a>
      <a wire:navigate href="{{ route('cars') }}" class="link link-hover hover:text-teal-500 transition">Voitures</a>
      <a wire:navigate href="{{ route('accueil') }}" class="link link-hover hover:text-teal-500 transition">Accueil</a>
      <a wire:navigate href="{{ route('dashboard') }}" class="link link-hover hover:text-teal-500 transition">Espace Client</a>
    </nav>
    <aside>
