...
<body class="bg-gradient-to-b from-whiteBlue to-neutral-200">
    ...
    <!-- Navbar -->
    <div class="navbar bg-mediumBlue px-24 py-1 sm:text-whiteBlue flex items-center justify-between">
        ...
        <div class="flex items-center max-md:hidden">
            ...
            @guest
                <details class="dropdown dropdown-end">
                    <summary class="m-0 btn bg-transparent border-transparent border-l-whiteBlue rounded-none p-0 hover:bg-transparent hover:border-transparent hover:border-l-lightBlue">
                        <i class="ri-user-3-fill text-whiteBlue text-xl py-2 px-3 hover:text-2xl transition-all"></i></summary>
                    <ul class="p-2 shadow menu dropdown-content z-[1] bg-base-100 rounded-box w-48 text-mediumBlue">
                    <li><a href="{{ route('login') }}" class="text-base hover:text-lightBlue px-3 py-2">Connexion</a></li>
