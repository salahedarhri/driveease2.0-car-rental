...
<body class="bg-mediumBlue">

    <!-- Navbar -->
    <div class="navbar bg-transparent px-2 py-0 sm:text-whiteBlue">
        ...
        <div class="flex flex-row justify-between">
          ...
          <ul class="menu menu-horizontal px-3 max-md:hidden">
            ...
            @auth
              <li class="md:px-1 lg:px-2 hover:translate-x-2 transition-transform duration-300 ease-in-out">
                <a href="{{ route('dashboard') }}" class=" md:text-lg text-base bg-emerald-600 hover:bg-emerald-500 bg-opacity-40">Espace Client</a></li>
            @endauth
            @guest
              <li class="md:px-1 lg:px-2 hover:translate-x-2 transition-transform duration-300 ease-in-out">
