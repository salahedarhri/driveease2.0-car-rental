...
<article x-data="{  scrollFocus(){ const element = document.getElementById('lieuDepart');
    ...
    <section class="max-w-6xl mx-auto py-6">
        ...
        <div class="w-full grid md:grid-cols-2 max-md:grid-cols-1 md:gap-6 max-md:gap-4 font-cabin p-2 bg-white rounded-lg shadow-lg">
            <section class="flex flex-col items-center p-3 gap-2">
                <img loading="lazy" src="{{ asset('images/composants/two-hands-shaking-600w.jpg')}}" 
            ...
            <section class="flex flex-col items-center p-3 gap-2">
                <img loading="lazy" src="{{ asset('images/composants/voiture-maintenance-600w.jpg') }}" 
            ...
            <section class="flex flex-col items-center p-3 gap-2">
                <img loading="lazy" src="{{ asset('images/composants/compteur-vitesse-voiture-600w.jpg')}}" 
            ...
            <section class="flex flex-col items-center p-3 gap-2">
                <img loading="lazy" src="{{ asset('images/composants/homme-conduisant-devant-soleil-600x400.jpg')}}" 
    ...
    {{-- Scroll top --}}
    <section class="h-full w-full mx-auto bg-cover bg-center"  style="background-image:url({{asset('images/composants/voiture-interieur-800w.jpg')}});">
        <div class="h-full w-full bg-gray-950 bg-opacity-40">
