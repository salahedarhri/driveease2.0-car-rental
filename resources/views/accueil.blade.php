    ...
    <form action="{{ route('voituresDisponibles')}}" method="post" class="w-full">
      ...
      <div class="grid w-full place-items-center gap-3 md:grid-cols-2 lg:grid-cols-4">
          <div class="w-full">
            ...
            class="appearance-none border-lightBlue rounded w-full py-3 pl-10 mt-2"
            style="background-image: url(' {{ asset('images/icons/location.png') }} '); background-repeat: no-repeat; background-position: 8px center; background-size: 1.5rem;">
            @error('lieuDepart')  <p class="text-red-600 mb-2">{{ $message }}</p> @enderror
          </div>
          <div class="w-full">
            ...
            class="appearance-none border-lightBlue rounded w-full py-3 pl-10 mt-2"
            style="background-image: url(' {{ asset('images/icons/location.png') }} '); background-repeat: no-repeat; background-position: 8px center; background-size: 1.5rem;">
            @error('lieuRetour')  <p class="text-red-600 mb-2">{{ $message }}</p> @enderror
          </div>
          <div class="w-full">
            ...
            <div class="relative">
              ...
              class="appearance-none border-lightBlue rounded w-full py-3 pl-10 mt-2"
              style="background-image: url(' {{ asset('images/icons/calendar.png') }} '); background-repeat: no-repeat; background-position: 8px center; background-size: 1.5rem;">
              <i class="absolute inset-y-0 left-0 flex items-center pl-3 text-gray-600 pointer-events-none"><i class="fas fa-user"></i></i>
            </div>

            @error('dateDepart')  <p class="text-red-600 mb-2">{{ $message }}</p> @enderror
          </div>
          <div class="w-full">
            ...
            class="appearance-none border-lightBlue rounded w-full py-3 pl-10 mt-2"
            style="background-image: url(' {{ asset('images/icons/calendar.png') }} '); background-repeat: no-repeat; background-position: 8px center; background-size: 1.5rem; ">
            @error('dateRetour')  <p class="text-red-600 mb-2">{{ $message }}</p> @enderror
          </div>
