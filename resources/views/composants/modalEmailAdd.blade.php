<div class="fixed inset-0 bg-slate-700 bg-opacity-50 flex items-center justify-center max-md:px-4 z-10">
    ...
    <!-- Modal -->
    <div  @click.away="openModalAdd=false" class="lg:w-2/5 md:w-3/5 max-md:w-full bg-white shadow-lg rounded border-2 border-lightBlue border-opacity-50 p-3 font-dmsans">
