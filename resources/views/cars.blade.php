            ...
            <div class="w-full grid grid-cols-2 max-md:grid-cols-1 gap-4 font-cabin p-2">
                ...
                <div class="flex flex-col items-center p-3 gap-2">
                    ...
                    <div class="text-center flex flex-col items-center pt-4">
                        ...
                        <p class="p-2 text-md">DriveEase propose une large gamme de véhicules pour répondre à tous vos besoins de déplacement au Maroc. Que vous ayez besoin d'une petite voiture pour la ville, d'un SUV pour les routes de montagne, ou d'une voiture de luxe pour des occasions spéciales, nous avons ce qu'il vous faut.</p>
                    </div>
                </div>
                <div class="flex flex-col items-center p-3 gap-2">
    ...
    <section class="h-full w-full mx-auto bg-cover bg-center"  style="background-image:url({{asset('images/composants/voiture-interieur.jpg')}});">
        <div class="h-full w-full bg-gray-950 bg-opacity-40">
            <div class="max-w-4xl mx-auto p-4 flex flex-col items-center align-middle justify-center md:h-largeHeight max-md:h-96">
                ...
                <button @click="focus=!focus" class="bg-gradient-to-r from-mediumBlue to-lightBlue hover:saturate-150 text-white font-semibold font-montserrat py-2 px-6 text-lg rounded-lg transition-all">Je réserve</button>
            </div>
        </div>
    </section>
</article>
